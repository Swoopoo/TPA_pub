...
cap_min = np.array(read_cap_file(datapath + 'c_min_ij.txt'))
cap_max = np.array(read_cap_file(datapath + 'c_max_ij.txt'))
...
solved = landweber(param, cap_min, cap_max, c_Phantom, norm, S, lw_iter, iterations)